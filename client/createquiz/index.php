    ...
    <div style="">
      ...
      <div id="questions">
        ...
        <div id="question">
          ...
          <div id="questionInfo">
            <br/>
            <center><input class="input" id="setQuestionName" value="" style="width: 75%;text-align: center;" maxlength="50" placeholder="Ask your question here..." /></center>
            <br/><br/>
      ...
      if(document.getElementById("setName").value.trim() != ""){///////////////
        ...
        for(var i=0; i<document.querySelectorAll("#question").length; i++) {
          if(document.querySelectorAll("#setQuestionName")[i].value.trim() != ""){///////////
            ...
            document.querySelectorAll("#setQuestionName")[i].setAttribute("maxlength","50");
