<?php
  ...
  if (isset($_SESSION['loginerror'])) {
    if ($_SESSION['loginerror'] == "Incorrect Email/Username or Password") {
      $_SESSION['loginerror'] = "";
      $loginError = "";
    }
    else {
  ...
  <body>
    ...
    <div>
      <div style="background-color: white;width:40%;position:absolute;left:30%;top:20vh;border-radius: 10px;">
        <br/>
        <center><h1 class="is-size-2">Register to Quizzard</h1></center>
        <br/>
        <form action="../../register.php" method="POST">
          ...
          <div style="position:relative;left:10%;">
            ...
            <span style="position:absolute;font-size: 25px;padding: 6.5px;"><i class="fas fa-envelope"></i></span><input type="text" required name="email" maxlength="100" style="width:80%;font-size:1.5em;border-radius: 5px;border-style:solid;" />
          </div>
          <br/>
          <div style="position:relative;left:10%;">
          ...
          <br/><br/>
          <center><input type="submit" placeholder="Register" style="padding: 10px 20px 10px 20px;background-color: rgb(104,64,146);border-radius: 20px;border-style: none;text-align:center;color:white;font-size: 1em;" /></center>
        </form>
        <center><p>Already on Quizzard? <a href="../login">Login here</a></p></center>
